...
if(NOT MSVC)
  ...
  # C++ only flags (invalid for C)
  enable_if_supported(COMPILER_FLAGS_CXX_ONLY "-Woverloaded-virtual")
  enable_if_supported(COMPILER_FLAGS_CXX_ONLY "-Wold-style-cast")
endif()
...
# C++ only (invalid for C)
enable_if_supported(COMPILER_FLAGS_CXX_ONLY "-fvisibility-inlines-hidden")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${COMPILER_FLAGS} ${COMPILER_FLAGS_CXX_ONLY}")
